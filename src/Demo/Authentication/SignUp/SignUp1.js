...
class SignUp1 extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            ApplicationAttachment: [
                { AttachmentID: 1, Name: "Access To Location Attachment", AttachmentFilePath: "", AttachmentName: "" },
                { AttachmentID: 2, Name: "Business Registration Attachment", AttachmentFilePath: "", AttachmentName: "" },
                { AttachmentID: 3, Name: "Office Facility Attachment", AttachmentFilePath: "", AttachmentName: "" },
                { AttachmentID: 4, Name: "Main Applicant Signature", AttachmentFilePath: "", AttachmentName: "" },
                { AttachmentID: 5, Name: "Applicant NIC", AttachmentFilePath: "", AttachmentName: "" }
            ],
        ...
        this.LeaseOrOwn = [{ ID: 1, Name: "Lease" }, { ID: 2, Name: "Own" },
    ...
    OnSaveValidation = () => {
        if (!this.FormLayout.validate().isValid && !this.FormLayout2.validate().isValid) {
                ...
                if (res.value) {
                    ...
                    this.serverRequest = axios
                        .post("/api/application", {
                            ...
                            ApplicationStoreLocation: JSON.stringify(this.state.ApplicationStoreLocation),
                            ApplicationProductSold: JSON.stringify(this.state.ApplicationProductSold),
                            ApplicationTransportInfomation: JSON.stringify(this.state.ApplicationTransportInfomation),
                            ApplicationRecomendationInformation: JSON.stringify(this.state.ApplicationRecomendationInformation),
                            ApplicationAttachment: JSON.stringify(this.state.ApplicationAttachment)
                        })
                        .then((response) => {
    ...
    onUploadStoreLocationClick = (e, FileName, FilePath) => {
        let Id = 0
        this.setState({ UploadStoreLocation: !this.state.UploadStoreLocation }, () => {
            ...
            if (!this.state.ListViewing) {
                ...
                this.state.ApplicationStoreLocation[Count].AttachmentFilePath = FilePath + "";
        ...
        this.setState({ UploadAttchment: !this.state.UploadAttchment }, () => {
            ...
            if (!this.state.ListViewing) {
                ...
                for (var i = 0; i < this.state.ApplicationAttachment.length; i++) {
                    ...
                    if (this.state.ApplicationAttachment[i].AttachmentID == AttachmentID) {
                        Count = i
                    }
                }

                this.state.ApplicationAttachment[Count].AttachmentFilePath = FilePath + "";
                    ...
                    <Card title="Submit You Application">
                        <Form ref={this.FormRef} formData={this.state.Application}>
                            <GroupItem caption="Applicant Information" colCount={2}>
                                ...
                                >
                                    <RequiredRule
                                        message="Field is required to fill" />
                                </Item>
                                <Item
                                    dataField="Email"
                                    editorOptions={{
                        ...
                        <Form>
                            <GroupItem caption="Names of Proprietor/Partner/Direcotrs" colCount={2}></GroupItem>
                        </Form>
                        <br />
                        <DataGrid
                            id="grid-list"
                        ...
                        <Form>
                            <GroupItem caption="Store Location Information" colCount={2}></GroupItem>
                        </Form>
                        <DataGrid
                            id="grid-list"
                        ...
                        <br />
                        <Form>
                            <GroupItem caption="Products Sold Information" colCount={2}></GroupItem>
                        </Form>
                        <DataGrid
                            id="grid-list"
                        ...
                        >
                            <Editing
                                ...
                                useIcons={true}
                            >
                                <Popup title="Add Your Competitor Products Sold Information" showTitle={true}></Popup>
                            </Editing>
                            <SearchPanel visible={true} />
                            <GroupPanel visible={true} />
                            <Paging defaultPageSize={20} />
                        ...
                        <br />
                        <Form>
                            <GroupItem caption="Transport Information" colCount={2}></GroupItem>
                        </Form>
                        <DataGrid
                            id="grid-list"
                        ...
                        >
                            <Editing
                                ...
                                useIcons={true}
                            >
                                <Popup title="Add Your Transport Infomation" showTitle={true}></Popup>
                            </Editing>
                            <SearchPanel visible={true} />
                            <GroupPanel visible={true} />
                            <Paging defaultPageSize={20} />
                            ...
                            <Column dataField="LeaseOrOwn" caption="Lease/Own" >
                                <Lookup dataSource={this.LeaseOrOwn} displayExpr="Name" valueExpr="ID" />
                            </Column>
                        </DataGrid>
                        <br />
                        <Form>
                        ...
                        >
                            <Editing
                                ...
                                useIcons={true}
                            >
                                <Popup title="Add Your Attachment Infomation" showTitle={true}></Popup>
                            </Editing>
                            <SearchPanel visible={true} />
                            <GroupPanel visible={true} />
                            <Paging defaultPageSize={20} />
